      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.span
            ...
            viewport={{ once: true }}
            className="text-[#F5A623] font-semibold text-sm uppercase tracking-wider"
          >
            Galleri
          </motion.span>
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white px-6 py-3 rounded-full font-semibold"
          >
